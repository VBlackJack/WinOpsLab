...
![Types de vSwitch Hyper-V](../../diagrams/hyperv-networking.drawio#Switchs_HyperV)

Hyper-V propose trois types de commutateurs virtuels (vSwitch) pour connecter les machines virtuelles :
